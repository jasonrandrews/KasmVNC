 ...
 * USA.
 */
#ifndef __RFB_TIGHTINDEXEDPNGENCODER_H__
#define __RFB_TIGHTINDEXEDPNGENCODER_H__
...
namespace rfb {
  ...
  class TightIndexedPNGEncoder : public Encoder {
  public:
    TightIndexedPNGEncoder(SConnection* conn);
    virtual ~TightIndexedPNGEncoder();
